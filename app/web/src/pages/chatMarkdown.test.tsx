...
vi.mock('./chat/mathDelimiters', async (importOriginal) => {
  const actual = await importOriginal<typeof import('./chat/mathDelimiters')>();
  return {
    ...actual,
...
// React root with it — a blank dashboard. KaTeX supplies a real one: a lone low
