 ...
 * `Some` iff `active`.
 */
started_at?: string, } | { "kind": "work_snapshot", session_id: string, user_id?: string, steps: Array<WireWorkStep>, } | { "kind": "approval_requested", call_id: string, session_id: string, user_id?: string, tool: string, accesses: Array<ResourceAccess>, params_preview: string,
/**
