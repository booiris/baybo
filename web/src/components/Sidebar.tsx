...
const navItem =
  'flex items-center gap-3 px-4 py-3 no-underline text-ink font-semibold rounded-md transition-all duration-200 border-2 border-transparent hover:bg-gray-100 cursor-pointer';
const navItemActive = 'bg-brand text-white border-[3px] border-black shadow-brutal-sm hover:bg-brand';

export function Sidebar() {
  return (
    <aside className="w-[200px] border-r-[3px] border-black flex flex-col bg-white shrink-0">
