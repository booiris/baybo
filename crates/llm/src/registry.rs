...
impl LlmProviderRegistry {
    ...
    /// whole thing in a [`BillableLlm`] sealed by `guard`. Returns
    /// `Arc<BillableLlm>` so callers can fan it out to consumers
