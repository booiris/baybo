...
goal      ──► model, store, tools (autonomous /goal objective; create_goal/get_goal/update_goal over the GoalStore trait + steering prompts; continuation engine lives in agent, consuming aura-goal's GoalService)
